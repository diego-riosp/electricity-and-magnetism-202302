...
\begin{frame}{Semana 7 (12/09/2023) - T6P7}
    Dos conductores cilíndricos delgados, coaxiales y largos están separados por un vacío. El cilindro interior tiene un radio $r_a$ y densidad de carga lineal $+\lambda$. El cilindro exterior tiene un radio $r_b$ y densidad de carga lineal $-\lambda$. Obtenga la capacitancia por unidad de longitud
    para este capacitor.
\end{frame}

\begin{frame}{Semana 7 (12/09/2023) - T6P8}
